...
def seed_servers():
    ...
    valorant = Server(admin_id=2, category='gaming', name='VALORANT', description='The VALORANT Discord server, in collaboration with Riot Games. We offer the latest news, LFGs and various chats.',
    ...
    minecraft = Server(admin_id=3, category='gaming', name='MINECRAFT', description='The official Minecraft Discord!',
    ...
    apex = Server(admin_id=4, category='gaming', name='Apex Legends', description='Community run, developer supported Discord server for Apex Legends. Join for LFG, game discussion, news & more!',
    ...
    legends = Server(admin_id=5, category='gaming', name='r/leagueoflegends', description='Community-run server for the League of Legends subreddit.',
    ...
    lofi = Server(admin_id=2, category='music', name='Lofi Girl', description='The friendliest community on Discord 🧡 Join now to meet amazing people from all around  the world 🌎.',
    ...
    hip_hop = Server(admin_id=3, category='music', name='Hip-Hop', description="Discord's #1 Music Server • Featured in XXL, Billboard, Complex, NME, Hypebeast, High Snobiety, Crack, & more!",
    ...
    monstercat = Server(admin_id=4, category='music', name='Monstercat', description='Empowering a creative and passionate community through innovation. Welcome to the family 😺.',
    ...
    dev_league = Server(admin_id=5, category='education', name='Game Dev League', description='GameDevLeague is a community built for Game Developers by Game Developers. Make, learn and grow with like minded people..',
    ...
    students = Server(admin_id=2, category='education', name='AP Students', description='A server where AP students can seek help and chat with other students',
    ...
    python = Server(admin_id=3, category='science', name='Python', description='GameDevLeague is a community built for Game Developers by Game Developers. Make, learn and grow with like minded people..',
    ...
    nvidia = Server(admin_id=4, category='science', name='NVIDIA', description="We're a friendly GameDev community that welcomes all skill levels - Unity / Unreal / C++ / C# 💖Meet, Learn, Share 💖",
    ...
    newegg = Server(admin_id=5, category='science', name='Newegg', description='The official Newegg.com Discord',
    ...
    anime = Server(admin_id=2, category='entertainment', name='Anime Soul Discord', description="1. Anime Network on Discord!💛🌐 We connect 500.000+ anime fans on Discord and Steam. Do you enjoy Anime? Join us!✨",
    ...
    soundworld = Server(admin_id=3, category='entertainment', name="Sound's World", description='Official server for the Discord YouTuber SoundDrout!🔗https://sounddrout.com/',
    ...
    yassine = User.query.get(3)
    hussein = User.query.get(4)
    leonardo = User.query.get(5)

    demo.servers.append(fortnite)
    nick.servers.append(valorant)
    yassine.servers.append(minecraft)
    hussein.servers.append(apex)
    leonardo.servers.append(legends)
    demo.servers.append(cod)
    nick.servers.append(lofi)
    yassine.servers.append(hip_hop)
    hussein.servers.append(monstercat)
    leonardo.servers.append(dev_league)
    demo.servers.append(dev_network)
    nick.servers.append(students)
    yassine.servers.append(python)
    hussein.servers.append(nvidia)
    leonardo.servers.append(newegg)
    demo.servers.append(streamlabs)
    nick.servers.append(anime)
    yassine.servers.append(soundworld)
    db.session.commit()
