...
def seed_servers():
    ...
    fornite = Server(admin_id=1, name='Official Fornite', description='The Official Fortnite Discord Server! Join to follow news channels, LFG, and chat.',
    ...
    valorant = Server(admin_id=1, name='VALORANT', description='The VALORANT Discord server, in collaboration with Riot Games. We offer the latest news, LFGs and various chats.',
    ...
    minecraft = Server(admin_id=1, name='MINECRAFT', description='The official Minecraft Discord!',
    ...
    apex = Server(admin_id=1, name='Apex Legends', description='Community run, developer supported Discord server for Apex Legends. Join for LFG, game discussion, news & more!',
    ...
    legends = Server(admin_id=1, name='r/leagueoflegends', description='Community-run server for the League of Legends subreddit.',
    ...
    cod = Server(admin_id=1, name='Call of Duty', description='The Call of Duty Discord server is a developer-recognized community focused on the first-person shooter franchise.',
